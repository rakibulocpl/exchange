...
@section('content')
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header bg-inverse-primary">{{ __('Edit User') }}</div>
                    <div class="card-body">
                        <form method="POST" action="{{ route('user.update') }}">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    {!! Form::select('branch',[''=>'Select branch']+$branches,$user->branch_id, $attributes = array('class'=>'form-control','required')) !!}
                                    @error('branch')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    {!! Form::select('status',$status,$user->status, $attributes = array('class'=>'form-control')) !!}
                                    @error('status')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
