...
{{--                    <h4 class="card-title">Component List <a class="btn btn-warning pull-right" href="{{route('brand.add')}}"><i class="icon-plus"></i> Add New</a> </h4>--}}
                </div>
                <div class="card-body">
