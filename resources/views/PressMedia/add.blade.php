...
@section('content')
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header bg-inverse-primary">{{ __('Add Media Item') }}</div>
                    <div class="card-body">
                        <form method="POST" action="{{ route('pressMedia.store') }}" enctype="multipart/form-data">
                            @csrf
