        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header bg-inverse-primary">
                    <h4 class="card-title">Component Item List <a class="btn btn-warning pull-right" href="{{route('component.itemAdd')}}"><i class="icon-plus"></i> Add New</a> </h4>
                </div>
                <div class="card-body">
    ...
    <script>
        $(function () {
            commonlist =$('#list').DataTable({
                ...
                iDisplayLength: 10,
                ajax: {
                    url: '{{route("component.getItemList")}}',
                    method: 'GET'
                },
                columns: [
                    ...
                    {data: 'addition_price', name: 'addition_price'},
