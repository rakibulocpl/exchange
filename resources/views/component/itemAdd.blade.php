        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('component.itemStore') }}">
                            @csrf
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    {!! Form::select('component',[''=>'Select Component'] +$component,old('component'), $attributes = array('class'=>'js-example-basic-single form-control',
                                                               'id'=>"component")) !!}
                                    @error('name')
