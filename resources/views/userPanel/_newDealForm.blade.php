...
@section('content')
    ...
    {{--    <link rel="stylesheet" href="{{ asset('css/newDealFromCss.css') }}">--}}
    <style>
                ...
                <div class="card" style="border:none;">
                    <div class="card-body">
                        ...
                        <div class="row ">
                            ...
                            <div class="col-md-12">
                                <form id="laptopexchangeform" action="{{route('user.newstore',[$category->id])}}"
                                    ...
                                    <div class=" card  setup-content" id="step-1">
                                        ...
                                        <div class="card-body bg-exchange form_card-body pt-0">
                                            ...
                                            <div class="row mt-1">
                                                {{--                                                <label for="brand" class=""><strong>Brand--}}
                                                {{--                                                    </strong> </label>--}}
                                                <div class="form_input">
                                            ...
                                            @if($category->id == 2)
                                                <div class="row mt-1">
                                                    ...
                                                    {{--                                                    <label for="inputLastName" class=""><strong>Model</strong></label>--}}
                                                    <div class="form_input">
                                            ...
                                            @endif
                                            <div class="row mt-1">
                                                {{--                                                <label class=" text-left" for="processor"><strong>Processor--}}
                                                {{--                                                    </strong></label>--}}
                                                <div class="form_input">
                                            ...
                                            <div class="row mt-1 ">
                                                {{--                                                <label class=" text-left" for="storage"><strong>Storage--}}
                                                {{--                                                    </strong></label>--}}
                                                <div class="form_input">
                                            ...
                                            @endif
                                            <div class="row mt-1">
                                                {{--                                                <label class="" for="graphics"><strong>Graphics--}}
                                                {{--                                                        Card </strong></label>--}}
                                                <div class="form_input">
                                                ...
                                                <div class="row form2_options ml-5">
                                                    ...
                                                    <div class="form-check form-check-inline">
                                                        <label class="form-check-label">
                                                            <input class="form-check-input form-input" required
                                                                   type="radio"
                                                                   name="displaystatus" value="fullfresh"/>
                                                            Display Broken
                                                        </label>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="form-check form-check-inline">
                                                        ...
                                                        <label class="form-check-label">
                                                            <input class="form-check-input " type="checkbox"
                                                                   name="more_condition_2" value="yes"/>
                                                            USB Not working
                                                        </label>
                                                    </div>
                                                    @if($category->id == 2)
                                                        <div class="form-check form-check-inline">
                                                            ...
                                                            <label class="form-check-label">
                                                                <input class="form-check-input " type="checkbox"
                                                                       name="more_condition_1" value="yes"/>
                                                                Web Cam Not Working
                                                            </label>
                                                        </div>
                                                        ...
                                                        <div class="form-check form-check-inline">
                                                            ...
                                                            <label class="form-check-label">
                                                                <input class="form-check-input" type="checkbox"
                                                                       name="more_condition_3" value="yes"/>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6  p-2 file-input text-center">
                                                        <input type="file" name="frontimage" id="frontimage"
                                                               class="form-control required file-input__input"/>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-6">
                                                                <img
                                                                        ...
                                                                        @else
                                                                            src="{{asset('images/samples/monitor.jpg')}}"
                                                                        @endif
                                                            ...
                                                            <div class="col-6">
                                                                <img @if($category->id == 2)
                                                                         src="{{asset('images/samples/laptop_sample_2.jpeg')}}"
                                                                     @else
                                                                         src="{{asset('images/samples/desktop.jpg')}}"
                                                                     @endif
                                                                     class="img-fluid" alt="Font image"
                                                                     id="backImagePreview"
            ...
            allNextBtn.click(async function () {
                ...
                var curStep = $(this).closest(".setup-content"),
                    ...
                    curInputs = curStep.find(
                        "input[type='text'],input[type='checkbox'],input[type='radio'],input[type='url'],select"
                    ),
                    isValid = true;
