...
@section('content')
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header bg-inverse-primary">{{ __('Page Edit') }}</div>
                    <div class="card-body">
                        <form method="POST" action="{{ route('page.store') }}">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    {!! Form::select('key', $pages,$page->key,['class' => 'form-control input-md required','id'=>'key']) !!}
                                </div>
                            </div>
                            <div class="form-group row">
                                <div class="col-md-12">
                                    <label for="meta_title" class="form-label">Meta Title</label>
                                    <textarea name="meta_title" class="form-control" id="meta_title">{{$page->meta_title}}</textarea>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                <div class="col-md-12">
                                    ...
                                    <textarea name="page_details" class="form-control required textEditor" id="page_details">{{$page->page_details}}</textarea>
                                </div>
                            </div>
