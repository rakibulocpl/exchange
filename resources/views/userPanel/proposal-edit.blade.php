            ...
            <div class="card   my-3 p-3">
                ...
                <div class="col-md-12" style="padding: 0 5% 0 5%;">
                    <form id="userRegistration" method="post" action="{{route('user.storeProposal')}}">
                        <input type="hidden" name="proposal_id" value="{{$appData->id}}" />
                        ...
                        <div class="position-relative">
                            <fieldset class="form-group border p-2">
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-6 ">
                                        ...
                                        <input type="text" name="company_name" value="{{$appData->company_name}}"
                                               class="form-control rounded required" id="company_name"/>
                                    </div>
                                    <div class="form-group col-md-6 ">
                                        <label for="district" class="required-star">District </label>
                                        {!! Form::select('district',[''=>'Select District'] +$district,$appData->district_id, $attributes = array('class'=>' form-control required',
                                                                                'id'=>"district")) !!}
                                    </div>
                                </div>
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-md-6 ">
                                        ...
                                        <textarea class="form-control required" id="address" name="address"
                                                  placeholder="Your Details Address">{{$appData->detail_addr}}</textarea>
                                    </div>
                                </div>
                                <div class="form-row">
                                    <div class="form-group col-md-6 ">
                                        <label class="required-star" for="revenue_yearly_bdt">Revenue Yearly (BDT) </label>
                                        <input type="text" name="revenue_yearly_bdt" value="{{$appData->revenue_yearly_bdt}}"
                                               class="form-control rounded number onlyNumber required" id="revenue_yearly_bdt"/>
                                    </div>
                                    <div class="form-group col-md-6 ">
                                        <label class="required-star" for="foreign_investment">Foreign Investment(BDT)</label>
                                        <input type="text" name="foreign_investment" value="{{$appData->foreign_investment}}"
                                               class="form-control rounded number onlyNumber required" id="foreign_investment"/>
                                    </div>
                                </div>
                                <div class="form-row">
                                    <div class="form-group col-md-6 ">
                                        <label class="required-star" for="local_investment">Local Investment (BDT)</label>
                                        <input type="text" name="local_investment" value="{{$appData->local_investment}}"
                                               class="form-control rounded number onlyNumber required" id="local_investment"/>
                                    </div>
                                    <div class="form-group col-md-6 ">
                                        <label class="required-star" for="number_of_existing_emp">Number of Existing Employee </label>
                                        <input type="text" name="number_of_existing_emp" value="{{$appData->number_of_existing_emp}}"
                                               class="form-control rounded number onlyNumber required" id="number_of_existing_emp"/>
                                    </div>
                                </div>
                                <div class="form-row">
                                    <div class="form-group col-md-6">
                                        ...
                                        <textarea class="form-control required" id="business_description" name="business_description"
                                                  placeholder="">{{$appData->business_description}}</textarea>
                                    </div>
                                    <div class="form-group col-md-6 ">
                                        ...
                                        <textarea class="form-control required" id="expansion_plan" name="expansion_plan"
                                                  placeholder="Expansion Plan">{{$appData->expansion_plan}}</textarea>
                                    </div>
                                </div>
                            ...
                            <fieldset class="form-group border p-2">
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-6 ">
                                        ...
                                        <input type="text" name="owner_name" value="{{$appData->owner_name}}"
                                               class="form-control rounded required" id="owner_name"/>
                                    </div>
                                    <div class="form-group col-md-6 ">
                                        <label class="required-star" for="owner_designation">Owner Designation </label>
                                        <input type="text" name="owner_designation" value="{{$appData->owner_designation}}"
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" class="form-control bd_mobile required"
                                               value="{{$appData->owner_contact_no}}"
                                               id="phone" name="phone"
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input name="email" type="email"    value="{{$appData->owner_email}}"
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-6 ">
                                        ...
                                        {!! Form::select('ownership_type',[''=>'Select Type'] +$ownershipType,$appData->ownership_type, $attributes = array('class'=>' form-control required',
                                                                                'id'=>"ownership_type")) !!}
                                    </div>
                                </div>
                            </fieldset>
                            <fieldset class="form-group border p-2">
                                ...
                                @include('userPanel/proposed_employment_info-edit')
                            </fieldset>
                            <fieldset class="form-group border p-2">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <input type="submit" name="actionBtn" formnovalidate  class="btn btn-primary  pl-4 pr-4 cancel" value="Save as Draft">
        ...
        $("#district").on("change", function () {
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    let selected = "{{$appData->thana_id}}";
                    $.each(response, function (key, row) {
                        if(selected == row.area_id){
                            option += '<option selected  value="' + row.area_id + '">' + row.area_nm + '</option>';
                        }else{
